...
namespace NesZord.Tests.OpCodes
{
	public class Describe_microprocessor_asl_operation : nspec
	{
		...
		public void When_use_accumulator_addressing_mode()
		{
			...
			{
				this.processor.Carry.should_be(randomByte.GetBitAt(Microprocessor.NEGATIVE_FLAG_BYTE_POSITION));
			};

			it["should set negative flag equal to seventh shifted value bit"] = () =>
			{
				this.processor.Negative.should_be(shiftedValue.GetBitAt(Microprocessor.NEGATIVE_FLAG_BYTE_POSITION));
			};
